...
from msaBase.models.sysinfo import (MSACPUFrequency, MSACPUStats, MSACPUTimes,
                                    MSADiskIO, MSAGPUInfo, MSAMemoryUsage,
                                    MSANetworkAdapter, MSANetworkAdapters,
                                    MSANetworkConnection, MSANetworkIO,
                                    MSANetworkStat, MSANetworkStats, MSASwap,
                                    MSASystemGPUInfo, MSASystemInfo,
                                    MSATemperature, MSATemperatures)
